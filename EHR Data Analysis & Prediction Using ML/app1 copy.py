...
st.title("Diagnosis Prediction & Treatment Recommendation")
st.write("Enter patient details to predict the most likely diagnosis and recommended treatment.")
...
# Define phenotype-driven treatment recommendations
treatment_guidelines = {
    "Diabetes": "Metformin, Lifestyle Changes",
    "Cardiac Risk": "Beta Blockers, Exercise",
    "Respiratory": "Inhalers, Oxygen Therapy",
    "Infectious Disease": "Antivirals, Isolation"
}

treatment_recommendation = treatment_guidelines.get(most_likely_diagnosis, "Consult a specialist")

# Display result
if st.button("Predict"):
    st.write(f"### Most Likely Diagnosis: {most_likely_diagnosis} ({highest_probability:.2%} likelihood)")
    st.write(f"### Recommended Treatment: {treatment_recommendation}")
